    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
	      ...
	      <div class="form-group">
				...
				<input type="text" class="form-control" placeholder="댓글 작성자" name="replyer" id="replyer" readonly="readonly">
		  </div>
		  <div class="form-group">
...
// 이벤트 연결용
	...
	$('div.panel-footer').on('click', 'li a', function (event) {
		...
		var targetPageNum = $(this).attr('href'); // attr()   prop() // attr 경로포함하지않고 값만 전달?
