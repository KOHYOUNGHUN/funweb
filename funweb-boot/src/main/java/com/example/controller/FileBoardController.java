...
//		}
	...
	public String fileWrite(HttpServletRequest request, @RequestParam("filename") List<MultipartFile> files,
...
//		String path = "C:/devtools/upload";
		...
		String strDate = this.getFoleder(); // 날짜 "년/월/일" 형식의 자열 리턴
...
//		List<FileItem> list = upload.parseRequest(request); // 멀티파트 바이트 조립해서 파일아이템 리스트로 반환
	...
	private boolean isImageType(File saveFile) throws IOException {
		...
		// MIME 확인하기 // 모든 확장자를 내포하진 않음 // MIME타입 정보가 없으면 null값 리턴
