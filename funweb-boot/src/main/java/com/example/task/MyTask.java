...
public class MyTask {
	...
	public void schedule1() {   // Junit처럼 public void에 매개변수 없는 형태로 , 메소드 이름은 상관없음
		long now = System.currentTimeMillis() / 1000;  // 현재시간의 밀리초  // long%int = long
